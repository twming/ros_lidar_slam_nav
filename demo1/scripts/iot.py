...
while not rospy.is_shutdown():
	...
	#mqtt.publish.single(topic, payload=tPayload, hostname=mqttHost, port=tPort, tls=tTLS, transport=tTransport)
	data="https://api.thinkspeak.com/update?api_key="+apiKey+"&"+tPayload
	print(data)
